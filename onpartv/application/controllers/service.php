...
class Service extends CI_Controller {
    ...
    //
    // Author Zhang Shui Jing //--2015.10.2--
    //
...
//        var_dump($postResult);
    ...
    public function my_file_conversion($targetFile, $file_name, $targetPath, $file_type) {
        ...
        if ($file_type === "video") { // video
            ...
            $cmd = 'ffmpeg -i ' . $targetFile . ' -ss 00:00:01 -vframes 1 -vf scale=-1:200 ' . $targetPath . $file_name . 't.png 2>&1';
            echo exec($cmd);
            // file length getting
            ...
            $cmd = 'ffmpeg -i ' . $targetFile . ' -vf scale=-1:200 ' . $targetPath . $file_name . 't.png 2>&1'; // thumbnails making
            echo exec($cmd);
